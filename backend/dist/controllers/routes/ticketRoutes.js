...
ticketRoutes.get("/tickets/contact/:contactId", isAuth_1.default, TicketController.findByContact);
...
ticketRoutes.get("/tickets-count-status", isAuth_1.default, TicketController.status);
