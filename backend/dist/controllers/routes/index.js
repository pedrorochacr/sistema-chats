...
const TypebotRoutes_1 = __importDefault(require("./TypebotRoutes"));
const whiteLabelsRoutes_1 = __importDefault(require("./whiteLabelsRoutes"));
const evolutionRoutes_1 = __importDefault(require("./evolutionRoutes"));
const EmailRoutes_1 = __importDefault(require("./EmailRoutes"));
const kanbanRoutes_1 = __importDefault(require("./kanbanRoutes"));
...
routes.use(TypebotRoutes_1.default);
...
routes.use(evolutionRoutes_1.default);
...
routes.use(kanbanRoutes_1.default);
routes.use(whiteLabelsRoutes_1.default);
