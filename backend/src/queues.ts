...
import SendInstanceMesageService  from "./services/EvolutionApiService/SendInstanceMessageService";
...
async function handleSendScheduledMessage(job) {
  ...
  try {
    let whatsapp = await Whatsapp.findByPk(scheduleRecord.whatsappId);
    ...
    await SendInstanceMesageService(messageData, whatsapp.name)
